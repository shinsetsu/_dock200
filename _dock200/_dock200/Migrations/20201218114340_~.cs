        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpType = table.Column<int>(nullable: true),
                    seenDate = table.Column<DateTime>(nullable: true),
                    timesSeenDay = table.Column<int>(nullable: true),
                    timesSeenCount = table.Column<long>(nullable: true),
                    totalIpsSeen = table.Column<long>(nullable: true),
